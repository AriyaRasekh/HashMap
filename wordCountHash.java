...
public class WordCountHash {
    ...
    public static void main(String[] args) throws Exception {
        String PATH = "/Users/ariyarasekh/Desktop/DtaLab/";
        String[] METHODS = { "HEAP", "HASH" };
        String[] DATASETS = {"dblp1k","dblp5k","dblp10k", "dblp100k", "dblp1m"};
        ...
        for (int j = 0; j < 5; j++) {
            ...
            for (int i = 0; i < 2; i++) {
                ...
                System.out.println(METHODS[i] + " method\t time = " + time + " seconds Most popular word is " + entry.getKey()
                        + " and total number repeated is " + entry.getValue());
            }
        }
    }
}
